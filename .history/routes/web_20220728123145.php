...
Route::group(['prefix' => 'admin'], function () {
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        */
        ...
        Route::get('/services/edit/{id}', [HaukingServiceController::class, 'create'])->name('service-edit');
        Route::post('/services/update/{id}', [HaukingServiceController::class, 'store'])->name('service-update');
        /**
        * Service end
        */
