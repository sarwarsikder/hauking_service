...
class HaukingServiceController extends Controller
{
    ...
    public function store(ServiceRequest $request)
    {
        try {
            ...
            print_r($request->all());
            print("asdasd");
            print_r($request->subscription_input_value);
            die;
            ...
            $serviceObject->default_value_night = json_encode(array("time"=>$request->default_value_day_time, "value"=>$request->default_value_day_value));
            $serviceObject->default_value_booster = json_encode(array("time"=>$request->default_value_day_time, "value"=>$request->default_value_day_value));
