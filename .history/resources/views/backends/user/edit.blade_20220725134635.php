        ...
        <div class="row" data-aos="fade-up">
            <div class="col-md-8 ">
                ...
                <div class="user-data-setting shadow ">
                    <form class="row g-3 adduserform" action="{{route('users-update')}}" method="post">
                        @csrf
                        <div class="col-md-6">
                            <input type="text"
                        ...
                        <div class="col-6">
                            <select class="form-control shadow-none @error('state') is-invalid @enderror" id="state" name="state">
                                ...
                                @foreach($states as $k=>$v)
                                    <option value="{{$v->id}}" {{ old('state') == $v->id ? "selected" : "" }}>{{$v->state_name}}</option>
                                @endforeach
                        ...
                        <div class="col-6">
                            <select class="form-control shadow-none @error('country') is-invalid @enderror" id="country" name="country" value="{{old('country')}}">
                                ...
                                @foreach($countries as $k=>$v)
                                    <option value="{{$v->country_code}}" {{ old('country') == $v->country_code ? "selected" : "" }}>{{$v->country_name}}</option>
                                @endforeach
