                ...
                <form class="row g-3 addserviceform" action="{{route('service-submit')}}" method="post">
                    ...
                    <table style="width:100%" class="current-data-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="subscriptionValue"
                                class="@error('subscription_type') is-invalid @enderror"
                                   name="subscription_type" id="subscriptionType" onchange="subscriptionValueSelector() ;">
                                    <option>Add Duration</option>
                    ...
                    <option value="Locked">Locked</option>
                                ...
                                <input type="number" id="valueStatus" name="" placeholder="Chargable Amount" id=""
                                    onchange="subscriptionValueSelector() ;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-12">
                                    <div class="col-6">
                                        <input type="checkbox" name="500" value="500">500

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="600" value="600">600

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="700" value="700">700
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="checkbox" name="1000_lock" value="1000_lock">Lock
                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="1100" value="1100">1100
                                        <input type="checkbox" name="1100_lock" value="1100_lock">Lock
                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="1200" value="1200">1200
                                        <input type="checkbox" name="1200_lock" value="1200_lock">Lock
                                    </div>
                                </div>
