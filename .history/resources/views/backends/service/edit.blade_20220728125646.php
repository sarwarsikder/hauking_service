                        ...
                        <tr>
                            ...
                            <td>
                                <select id="default_value_night_time"
                                    ...
                                    <option value="">Select Value</option>
                                    <option value="8AM"
                                        {{ json_decode($service->default_value_day)->time  == "8AM" ? "selected" : "" }}>8:00 AM
                                    </option>
                                    <option value="9AM"
                                        {{ json_decode($service->default_value_day)->time  == "8AM" ? "selected" : "" }}>9:00 AM
                                    </option>
                                    <option value="10AM"
                                        {{ json_decode($service->default_value_day)->time  == "8AM" ? "selected" : "" }}>10:00 AM
                                    </option>
                                </select>
