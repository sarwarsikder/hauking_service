                ...
                <form class="row g-3 addserviceform" action="{{URL::to('admin/services/update/'.$service->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <option value="Locked">Locked</option>
                        ...
                        <tr>
                            ...
                            @if($service->)
                            <p>test3 *<span class="deleteBtn"><i class="bi bi-dash-circle"></i></span></p>
                            <input type="text" required="" id="inputVal01"> 
                            <p>test2 *<span class="deleteBtn"><i class="bi bi-dash-circle"></i></span></p>
                            <input type="number" required="" id="inputVal11">
                            </td>
                        </tr>
                        <!-- <tr>
                            <th></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="default_value_night_time"
                                    ...
                                    <option value="9AM"
                                        {{ json_decode($service->default_value_night)->time  == "8AM" ? "selected" : "" }}>9:00 AM
                                    </option>
                                    <option value="10AM"
                                        {{ json_decode($service->default_value_night)->time  == "8AM" ? "selected" : "" }}>10:00 AM
                                    </option>
                                </select>
