                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-12">
                                    ...
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="600" {{ old('hawkin_scale') == 600 ? "checked" : "" }}>600

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="700" {{ old('hawkin_scale') == 700 ? "checked" : "" }}>700

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="800" {{ old('hawkin_scale') == 800 ? "checked" : "" }}>800

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="900" {{ old('hawkin_scale') == 900 ? "checked" : "" }}>900

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="1000" {{ old('hawkin_scale') == 1000 ? "checked" : "" }}>1000
                                        <input type="checkbox" name="hawkin_scale_lock" value="Lock_1000" {{ old('hawkin_scale') == "Lock_1000" ? "checked" : "" }}>Lock
                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="1100" {{ old('hawkin_scale') == 1100 ? "checked" : "" }}>1100
