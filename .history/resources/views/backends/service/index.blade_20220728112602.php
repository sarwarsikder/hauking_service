                                            ...
                                            <table class="table">
                                                ...
                                                @foreach ($haukings as $hauking)
                                                    <tr>
                                                        ...
                                                        <td scope="row"><a href="#">{{$hauking->hawkin_scale}}</a></td>
                                                        <td scope="row"><a href="#">{{$hauking->data_fields}}</a></td>
                                                        <td scope="row"><a href="#">{{$hauking->default_value_day}}</a></td>
                                                        <td scope="row"><a href="#">{{$hauking->default_value_night}}</a></td>
                                                        <td scope="row"><a href="#">{{$hauking->default_value_booster}}</a></td>
                                                        <td scope="row"><a href="#">{{$hauking->default_special_feq}}</a></td>
                                                        <td scope="row"><a href="#">{{$hauking->service_image_url}}</a></td>
                                                        <td scope="row">
                                                            <label class="switch">
                                                                <input type="checkbox"
