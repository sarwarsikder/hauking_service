                    ...
                    <option value="Locked">Locked</option>
                        ...
                        <tr>
                            ...
                            @foreach(json_decode($service->data_fields) as $k=>$v)
                                ...
                                <input type="{{$v->type}}" @if($v->dataType=="required") required @endif /> 
                            @endforeach
                            @endif
                            </td>
                        </tr>
...
<script>
    let subscriptionInputValue = JSON.parse("{{$service->subscription_type}}");
    let subscriptionStringyfyValue = '';
    
    let dataFieldInputValue = JSON.parse("{{$service->data_fields}}");
    let dataFieldStringyfyValue = '';
    
    
    console.log(subscriptionInputValue)
    console.log(dataFieldInputValue)
    $(function () {
