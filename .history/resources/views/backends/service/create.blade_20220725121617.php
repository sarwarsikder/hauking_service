                            ...
                            <td>
                                <div class="col-12">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="checkbox" name="hawkin_scale_lock" value="1000_lock">Lock
                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="1100">1100
                                        <input type="checkbox" name="hawkin_scale_lock" value="1100_lock">Lock
                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="1200">1200
                                        <input type="checkbox" name="hawkin_scale_lock" value="1200_lock">Lock
                                    </div>
                                </div>
