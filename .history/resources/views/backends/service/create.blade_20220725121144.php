            ...
            <div class="user-data-setting shadow ">
                <form class="row g-3 addserviceform" action="{{route('service-submit')}}" method="post">
                    ...
                    <option value="Locked">Locked</option>
                                ...
                                <input type="number" class="@error('subscription_amount') is-invalid @enderror" id="subscription_amount" name="subscription_amount" placeholder="Chargable Amount" id=""
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" name="trial_period" id="trial_period" placeholder="Number of days">
                            </td>
                        </tr>
                        <tr>
