...
<script>
    $(function () {
        ...
        $("#addSubscriptionValue").on("click",function(){
            ...
            if(stringyfyValue){
                subscriptionInputValue = JSON.parse(stringyfyValue)
            }
                ...
                subscriptionInputValue.push(a);
                    ...
                    for (let i = 0; i < deleteBtn.length; i++) {
                        deleteBtn[i].addEventListener("click", () => {
                            ...
                            stringyfyValue = JSON.stringify(subscriptionInputValue)
                            $("#subscriptionInputValue").val(stringyfyValue);    
                        });
                    }
            }
        ...
        $("#addDataFieldBtn").on("click",function(){
                ...
                dataFieldInputValue = JSON.parse(dataFieldInputValue)
                if(inputDataFields){
            ...
            $("#dataFieldFormInputValue").val(JSON.stringify(dataFieldInputValue));
