                    ...
                    <option value="Locked">Locked</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-12">
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="500" {{ old('hawkin_scale') == 500 ? "checked" : "" }}>500

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="600" {{ old('hawkin_scale') == 500 ? "checked" : "" }}>600

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="700" {{ old('hawkin_scale') == 500 ? "checked" : "" }}>700

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="800" {{ old('hawkin_scale') == 500 ? "checked" : "" }}>800

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="900" {{ old('hawkin_scale') == 500 ? "checked" : "" }}>900

                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="1000" {{ old('hawkin_scale') == 500 ? "checked" : "" }}>1000
                                        <input type="checkbox" name="hawkin_scale_lock" value="Lock_1000" {{ old('hawkin_scale') == 500 ? "checked" : "" }}>Lock
                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="{{old('hawkin_scale')}}" {{ old('hawkin_scale') == 500 ? "checked" : "" }}>1100
                                        <input type="checkbox" name="hawkin_scale_lock" vvalue="Lock_1100" {{ old('hawkin_scale') == "Lock_1100" ? "checked" : "" }}>Lock
                                    </div>
                                    <div class="col-6">
                                        <input type="checkbox" name="hawkin_scale" value="1200" {{ old('hawkin_scale') == 1200 ? "checked" : "" }}>1200
                                        <input type="checkbox" name="hawkin_scale_lock" value="Lock_1200" {{ old('hawkin_scale') == Lock_1200 ? "checked" : "" }}>Lock
                                    </div>
                                </div>
                            </td>
                        </tr>
