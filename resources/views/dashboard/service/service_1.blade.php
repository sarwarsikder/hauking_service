                ...
                <div style="overflow-x:auto;" data-aos="fade-up" class="shadow bg-white  py-5 px-4">
                    ...
                    <table style="width:100%" class="current-data-table">
                        ...
                        <tr>
                            ...
                            <td>
                                <select id="subscriptionValue" onchange="subscriptionValueSelector() ;">
                    ...
                    <option value="Locked">Locked</option>
                                ...
                                <input type="number" id="valueStatus" name="" placeholder="Chargable Amount"
                                    id="" onchange="subscriptionValueSelector() ;">
                    ...
                    <div class="col-6 service1submit ">
