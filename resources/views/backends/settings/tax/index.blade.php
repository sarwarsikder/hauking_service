                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="table-left">
                                        <a href="{{route('taxes-create')}}" class="add-user"> <span><i class="bi bi-person-plus"></i></span> Add
                                            Tax</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-nowrap" scope="col">Country Code</th>
                                        ...
                                        @foreach ($taxes as $tax)
                                            <tr>
                                                ...
                                                <td scope="row">
                                                    <label class="switch">
                                                        <input type="checkbox"
                                                               {{($tax->status==true)?"checked":""}}  data-id="{{$tax->id}}"
                                                               class="toggle-class">
